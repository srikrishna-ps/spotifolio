        ...
        <div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://github.com/srikrishnap"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-spotify-darkgray rounded-full flex items-center justify-center text-spotify-lightgray hover:text-white transition-colors hover:scale-105 hover:shadow-lg"
              >
              ...
              <a
                href="https://linkedin.com/in/srikrishnap"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-spotify-darkgray rounded-full flex items-center justify-center text-spotify-lightgray hover:text-white transition-colors hover:scale-105 hover:shadow-lg"
              >
              ...
              <a
                href="https://twitter.com/srikrishnap"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-spotify-darkgray rounded-full flex items-center justify-center text-spotify-lightgray hover:text-white transition-colors hover:scale-105 hover:shadow-lg"
              >
              ...
              <a
                href="https://instagram.com/srikrishnap"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-spotify-darkgray rounded-full flex items-center justify-center text-spotify-lightgray hover:text-white transition-colors hover:scale-105 hover:shadow-lg"
              >
